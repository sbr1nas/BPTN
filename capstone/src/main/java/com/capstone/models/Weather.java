...
public class Weather implements Serializable {
	...
	public Weather(int weatherId, String name, String description, String icon, Instant sunrise, Instant sunset,
			BigDecimal tempMin, BigDecimal tempMax, BigDecimal tempDay, BigDecimal tempNight, BigDecimal tempMorning, BigDecimal tempEvening,
			BigDecimal feelsLikeDay, BigDecimal feelsLikeNight, BigDecimal feelsLikeMorning, BigDecimal feelsLikeEvening,
			BigDecimal precipitation, BigDecimal windSpeed, BigDecimal windDirection, BigDecimal windGust, BigDecimal pressure,
